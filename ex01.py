...
con = pymysql.connect(host='localhost', user='root', password='Arim1004!', db='python_test', charset='utf8')
cur = con.cursor()
...
for i in range(0,len(ndata)) :
    ...
    sql = "INSERT INTO subject_name VALUES (%s, %s)"
    val = (name_val_01, name_val_02)
    cur.execute(sql, val)
    con.commit()
